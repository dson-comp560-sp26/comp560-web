...
| Score | Criteria |
|-------|----------|
| 90-100 | Activity log and deliverables provide convincing evidence of a minimum of <s>10</s><font color="red">7</font> hours' effort per week and include providing help to other students; contributions are of very high quality and at least some contributions represent research achievement; <font color="red">meeting attendance adheres to policy</font> |
| 80-89 | Activity log and deliverables provide convincing evidence of a minimum of <s>10</s><font color="red">7</font> hours' effort per week; contributions are of good quality but need not represent research achievement; <font color="red">meeting attendance adheres to policy</font> |
| 70-79 | Activity log and deliverables provide evidence of substantial effort (at least a few hours per week); contributions meet minimal expectations for quality; <font color="red">meeting attendance adheres to policy</font>|
...
An _activity log_ is a private Microsoft Teams channel in which a student keeps a log of all activity for the course, preferably updated several times per week. Activity logs are discussed in more detail on the separate [activity log page](activity-logs.md). 

### Deliverables

A _deliverable_ is any output produced by work on the project. Deliverables include:
